document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadCSV() {
        Promise.all([
            ...
            const margin = { top: 40, right: 150, bottom: 50, left: 60 }, // Increased left margin
                  width = 1200 - margin.left - margin.right, // Reduced width
                  height = 650 - margin.top - margin.bottom; // Reduced height
            ...
            function updateChart(country) {
                ...
                const legend = svg.selectAll(".legend")
                    ...
                    .enter().append("g")
                    .attr("class", "legend")
                    .attr("transform", (d, i) => `translate(${width + 40},${i * 20 + 20})`); // Moved legend to the left
